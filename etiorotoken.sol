...
/**
 *Submitted for verification at tronscan on 2020-12-10
*/
...
*   +-----------------------------------------------------------------------+  
*   ¦   Website: https://cryptoetioro.wordpress.com/                        ¦
*   ¦                                                                       ¦  
*   ¦   >>GRUPO TELEGRAM [ESPAÑOL]                                          |
*   ¦     http://t.me/etioro_tokens_es                                      |
*   ¦                                                                       |
*   ¦   >>GRUPO TELEGRAM [INGLÉS]                                           |
*   ¦     http://t.me/etioro_tokens_en                                      |
*   ¦                                                                       |
*   ¦   >>TWITTER                                                           |
*   ¦     https://twitter.com/etioro                                        |                           
*   ¦                                                                       |                               
*   ¦   >>E-mail                                                            |
*   ¦     cryptoetioro@gmail.com                                            |          
*   ¦                                                                       |
*   ¦                                                                       |
*   +-----------------------------------------------------------------------+ 

* by Global Finance Company
* https://cryptoetioro.wordpress.com/
...
contract Context {
    ...
    function _msgData() internal view returns (bytes memory) {
        this; // silence state mutability warning without generating bytecode - see https://github.com/tron/solidity/issues/2691
        return msg.data;
    }
}
...
contract ETIORO is TRC20, TRC20Detailed, TRC20Burnable  {
   constructor (uint256 total_Supply) public TRC20Detailed("ETIORO","ETX",6) {
